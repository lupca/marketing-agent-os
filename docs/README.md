# 📚 HỆ THỐNG TÀI LIỆU DỰ ÁN: MARKETING AGENT OS v2.0
...
*   📄 **[core_architecture.md](file:///wsl.localhost/server/root/marketing-agent-os/docs/02_architecture/core_architecture.md):** 6 tinh túy kiến trúc của Agent OS v2.0 (Phân quyền Business/Creative, A/B Testing tự trị, RAG phân tầng).
